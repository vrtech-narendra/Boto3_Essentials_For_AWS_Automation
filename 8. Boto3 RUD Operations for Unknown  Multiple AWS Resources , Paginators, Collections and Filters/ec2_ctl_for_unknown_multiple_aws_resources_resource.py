...
def main():
    try:
        ...
        #Finding all EC2 Instances for a given condition like tag key projectname and tag value payments
        ...
        for eachInstance in instance_iterator:
            instanceIds.append(eachInstance.id)
        if len(instanceIds) == 0 :
            print(f"There are no ec2 instances under given region {region}")
            sys.exit(0)
