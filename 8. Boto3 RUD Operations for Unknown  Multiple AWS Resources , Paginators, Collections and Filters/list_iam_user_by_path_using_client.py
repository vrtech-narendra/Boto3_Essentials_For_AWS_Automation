...
try:
    ...
    response_iterator = paginator.paginate(PathPrefix='/devops/')
    # responses=[]
    # response = iamClient.list_users(PathPrefix='/devops/', MaxItems=1000)
    # responses.append(response)
    # Marker = response.get('Marker')
    
    # while Marker:
    #     response = iamClient.list_users( PathPrefix='/devops/',MaxItems=1000, Marker=Marker)
    #     responses.append(response)
    #     Marker = response.get('Marker')        
